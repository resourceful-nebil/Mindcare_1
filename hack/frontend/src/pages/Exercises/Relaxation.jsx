...
const RelaxationExercise = () => {
  return (
    <div>
      ...
      <h3>2. Guided Imagery</h3>
      <p>
        Find a quiet place and close your eyes. Imagine yourself in a peaceful and serene environment, such as a beautiful beach or a tranquil forest. Engage your senses and vividly imagine the sights, sounds, smells, and sensations of this place. Allow yourself to fully immerse in the experience and let go of any stress or worries.
      </p>

      <h3>3. Deep Breathing</h3>
      <p>
        Sit or lie down in a comfortable position. Close your eyes and take a deep breath in through your nose, filling your lungs with air. Hold your breath for a few seconds, then exhale slowly through your mouth, releasing any tension or stress. Repeat this deep breathing pattern several times, focusing on each breath and allowing your body and mind to relax with each exhale.
      </p>

      <h3>4. Body Scan Relaxation</h3>
      <p>
        Lie down in a comfortable position and close your eyes. Begin to bring your attention to different parts of your body, starting from your toes and moving upward. Notice any areas of tension or discomfort and consciously release the tension as you exhale. Move slowly up through your body, relaxing each muscle group and letting go of any stress or tightness.
      </p>

      <h3>5. Guided Meditation</h3>
      <p>
      ...
      <h3>6. Progressive Relaxation Visualization</h3>
    <p>
    ...
    <h3>7. Sensory Grounding Exercise</h3>
    <p>
    ...
    <h3>10. Progressive Relaxation with Affirmations</h3>
    <p>
    ...
    <h3>11. Mindful Breathing with Counting</h3>
    <p>
    ...
    <h3>12. Yoga or Stretching Routine</h3>
    <p>
    ...
    <h3>13. Nature Walk or Outdoor Meditation</h3>
    <p>
    ...
    <h3>14. Journaling and Reflection</h3>
    <p>
    ...
    <h3>15. Progressive Relaxation Music</h3>
    <p>
    ...
    <h3>18. Self-Massage</h3>
    <p>
      Use gentle self-massage techniques to relax your body and relieve tension. Start with your shoulders and neck, using your hands or a massage tool to apply gentle pressure and circular motions. Gradually move down to your arms, hands, legs, and feet, focusing on areas of tension. Massage promotes relaxation and helps release accumulated stress in the body.
    </p>

    <h3>19. Breathing Visualization</h3>
    <p>
